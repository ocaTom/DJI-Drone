...
@SuppressLint("ViewHolder") public class SelectDroneTypeActivity extends MainActivity
{
    ...
    private  class SelectDroneTypeAdapter extends BaseAdapter {
        ...
        public View getView(int index, View convertView, ViewGroup parent) {
            convertView = View.inflate(SelectDroneTypeActivity.this, R.layout.activity_select_drone_type, null);
